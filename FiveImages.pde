...
void setup() {
  ...
  imageX1 = width*1/4;
  imageY1 = height*0;
  imageWidth1 = (width-1)*1/4; //CANVAS (0,0) means point doesn't match to rectangle, missing outline on two sides
  imageHeight1 = (height-1)*1/4;
  imageX2 = width*0;
  imageY2 = height*1/4;
  imageWidth2 = width-1; //CANVAS (0,0) means point doesn't match to rectangle, missing outline on two sides
  imageHeight2 = (height-1)*1/4;
  imageX3 = width;
  imageY3 = height;
  imageWidth3 = width;
  imageHeight3 = height;
