...
void setup() {
  ...
  imageX1 = width*0;
  imageY1 = height*0;
  imageWidth1 = (width-1)*1/3; //CANVAS (0,0) means point doesn't match to rectangle, missing outline on two sides
  ...
  imageHeight2 = (height-1)*1/3;
  imageX3 = width*1/3;
  imageY3 = height*2/3;
  imageWidth3 = width-1;
  imageHeight3 = height-1;
  //
...
void Draw() {
  background(0);
  image(webImg1, 750, 750);
  rect(imageX1, imageY1, imageWidth1, imageHeight1); //Top Half of CANVAS
  rect(imageX2, imageY2, imageWidth2, imageHeight2); //Center Half of CANVAS
  rect(imageX3, imageY3, imageWidth3, imageHeight3); //Bottom Half of CANVAS
